...
| `expenses`  | `budget` (pre-save over-budget check on the expense log and quick-add screens); `income` (the unified Add-Transaction sheet on the Transactions tab composes income entry) |
