 ...
 * own family. Headings and display text use Space Grotesk (geometric, distinctive);
...
export const FONT_FAMILY = {
  SPACE_GROTESK_SEMIBOLD: 'SpaceGrotesk_600SemiBold',
  SPACE_GROTESK_BOLD: 'SpaceGrotesk_700Bold',
